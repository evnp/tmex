...
Top-level layout sizing (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
----------------------------------------------------------------------------------------------------
...
This special case is handled by placing the sizing clause at the _start_ of the layout (prior to [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5), this would result in an invalid layout error):
```sh
...
Grid sub-layouts (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
---------------------------------------------------------------------------------------------
...
Multi-digit pane counts (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
----------------------------------------------------------------------------------------------------
...
Focused Pane Control (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
-------------------------------------------------------------------------------------------------
...
Multi-window management (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
----------------------------------------------------------------------------------------------------
...
Usage within tmux sessions (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
---------------------------------------------------------------------------------------------
...
Kill command (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.5) 🐣)
---------------------------------------------------------------------------------------------
...
brew test tmex
==> Testing tmex
==> /opt/homebrew/Cellar/tmex/2.0.5/bin/tmex test --print 1234 hello world
```
