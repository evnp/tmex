...
Top-level layout sizing (new in [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7) 🐣)
----------------------------------------------------------------------------------------------------
...
This special case is accomplished by placing the sizing clause at the _start_ of the layout (prior to [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7), this would result in an invalid layout error):
```sh
...
Grid sub-layouts (new in [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7) 🐣)
---------------------------------------------------------------------------------------------
...
Multi-digit pane counts (new in [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7) 🐣)
----------------------------------------------------------------------------------------------------
...
Focused Pane Control (new in [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7) 🐣)
-------------------------------------------------------------------------------------------------
...
Multi-window management (new in [v2.0.0-rc.7](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.7) 🐣)
----------------------------------------------------------------------------------------------------
...
brew test tmex
==> Testing tmex
==> /opt/homebrew/Cellar/tmex/2.0.0-rc.7/bin/tmex test --print 1234 hello world
```
