...
Top-level layout sizing (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
----------------------------------------------------------------------------------------------------
...
This special case is accomplished by placing the sizing clause at the _start_ of the layout (prior to [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8), this would result in an invalid layout error):
```sh
...
Grid sub-layouts (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
---------------------------------------------------------------------------------------------
...
Multi-digit pane counts (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
----------------------------------------------------------------------------------------------------
...
Focused Pane Control (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
-------------------------------------------------------------------------------------------------
...
Multi-window management (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
----------------------------------------------------------------------------------------------------
...
Usage within tmux sessions (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
---------------------------------------------------------------------------------------------
...
Kill command (new in [v2.0.0-rc.8](https://github.com/evnp/tmex/releases/tag/v2.0.0-rc.8) 🐣)
---------------------------------------------------------------------------------------------
