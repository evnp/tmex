...
Multi-window management (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.4) 🐣)
----------------------------------------------------------------------------------------------------
...
Kill command (new in [v2](https://github.com/evnp/tmex/releases/tag/v2.0.4) 🐣)
---------------------------------------------------------------------------------------------
